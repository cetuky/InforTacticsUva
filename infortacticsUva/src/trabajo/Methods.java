...
public class Methods {
	...
	public static void startGame(Scanner in, String[] playerDeck, String[] enemyDeck) {
		...
		if(winner==1) {
			...
			System.out.println("Vaya.. �P	erdiste!");
		}else {
	...
	/**
	 * Procedimiento que rellena el vector de juego en funci�n de los vectores propios y del enemigo
	 * Primero, inicializamos el vector de juego a todas sus posiciones con cadena vac�a "".
	...
	/**
	 * Funci�n que comprueba si hay un ganador, comprobando los personajes vivos en el vector de juego 
	 * @author Alejandro Ortega
	 * @param gameDeck Referencia al vector de juego con los personajes intercalados
	 * @param j		   Posici�n en el vector del turno actual: pares->jugador impares->enemigo
	 ...
	 * @param j		   Posici�n del vector que representa el turno: pares->jugador, impares->enemigo
	 * @param advance  Valor que indica si el personaje debe avanzar si no hay ning�n jugador al que golpear
	 */
	...
	/**
	 * Procedimiento que realiza un ataque al personaje m�s lejano utilizando la distancia eucl�dea: Arquera & Princesa
	 * @author Alejandro Ortega
	 * @param gameDeck Referencia al vector de juego
	 * @param j		   Posici�n del vector que representa el turno: pares->jugador, impares->enemigo
	 */
	...
	/**
	 * Procedimiento que escribe en un vector de Strings todas las posiciones a cadenas vac�as
	 * @author Alejandro Ortega
	 ...
	 * @author Alejandro Ortega
	 * @param  symbol Car�cter del personaje
	 * @return Icono del personaje en formato String o "S�mbolo err�neo" si no existe
	 */
